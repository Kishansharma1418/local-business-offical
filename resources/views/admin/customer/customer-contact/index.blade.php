...
@section('content')
    <div class="main-content-container overflow-hidden">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4 mt-1">
            <h3 class="mb-0">Customer Contact List</h3>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center mb-0 lh-1">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <span class="text-secondary">Customer Contact List</span>
                    </li>
                </ol>
            </nav>
        </div>
                    ...
                    <table class="table" id="customerContactTable">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="fw-medium">Default Contact</th>
...
@push('scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#customerContactTable')) {
                var dataTable = $('#customerContactTable').DataTable({
                    processing: true,
                    serverSide: true,
                    autoWidth: true,
                    scrollX: false,
                    ...
                    ajax: {
                        url: "{{ url('customer-contact-list') }}/" + customerId,
                        data: function(d) {}
                    },
            ...
            $(document).on('click', '.deleteBranchBtn', function() {
                if (confirm('Are you sure want to delete this Customer contact?')) {
                    var id = $(this).data('id');
                    $.ajax({
                        url: "{{ route('customer.contactdelete.delete', ':id') }}".replace(':id',
                            id),
                        type: 'DELETE',
                        data: {
                            _token: "{{ csrf_token() }}"
