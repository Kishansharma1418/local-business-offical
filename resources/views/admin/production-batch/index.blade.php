...
@section('content')
    <div class="main-content-container overflow-hidden">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4 mt-1">
            <h3 class="mb-0">RequisitionBatch</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center mb-0 lh-1">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <span class="text-secondary">Requisition Batch</span>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="card bg-white rounded-10 border border-white mb-4">
            ...
            <div class="d-flex align-items-center flex-wrap gap-3 p-20">
                ...
                <a href="{{ route('production-batch.create') }}"
            ...
            <div class="modal fade" id="assignteam" tabindex="-1" aria-labelledby="assignTeamModalLabel"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered rounded-10" style="max-width: 550px;">
                    <form id="assignTeamForm" class="modal-content bg-white" action="{{ route('assignTeam') }}"
                        method="POST">
                        @csrf

                        <!-- HIDDEN FIELDS -->
                        <input type="hidden" id="stage" name="stage" value="REQUISITION">
...
@push('scripts')
    <script>
        $(function() {
            ...
            var table = $('#bomMasterTable').DataTable({
                ...
                ajax: {
                    url: "{{ route('production-batch.index') }}",
                    type: "GET",
                    data: function(d) {
    ...
    <script>
        $(document).on('click', '.assign-team-btn', function() {
            ...
            $.get(`/production-batch/${productionId}/roles`, function(roles) {
                roles.forEach(role => {
