...
@section('content')
    <div class="main-content-container overflow-hidden">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4 mt-1">
            <h3 class="mb-0">Unit of Measure List</h3>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center mb-0 lh-1">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <span class="text-secondary">Unit of Measure List</span>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="card bg-white rounded-10 border border-white mb-4">
            ...
            <div class="d-flex  align-items-center flex-wrap gap-3 p-20">
                <button class=" btn btn-primary fw-normal text-white fs-16 border-0 p-3" data-bs-toggle="modal"
                    data-bs-target="#exampleModal">+ Add Unit
                </button>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered rounded-10" style="max-width: 550px;">
            <form class="modal-content bg-white" method="Post" enctype="multipart/form-data" id="add_uom_form">
                @csrf
                <input type="hidden" id="class_route" value="{{ route('uom.store') }}">

                <div class="modal-header border-border-color-40 p-20">
                    <h1 class="modal-title fs-18 fw-medium mb-0" id="exampleModalLabel">Add New UOM</h1>
                ...
                <div class="modal-body p-20 pb-0">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="mb-20">
                                <label class="label">UOM Name <span class="text-danger">*</span></label>
                                <div class="form-floating">
                                    <input type="name" class="form-control" id="floatingInput" name="name"
                                        placeholder="UOM Name" data-rule-required="true">
                                    <label for="floatingInput">UOM Name</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="mb-20">
                                <label class="label">UOM Description</label>
                                <div class="form-floating">
...
@push('scripts')
    ...
    <script>
        handleModalFormSubmit('#add_uom_form', '#exampleModal', '#uomTable', 'UOM created successfully');
        handleModalUpdateSubmit('#edit_uom_form', '#edit_model', '#uomTable','UOM updated successfully');
    </script>
@endpush
