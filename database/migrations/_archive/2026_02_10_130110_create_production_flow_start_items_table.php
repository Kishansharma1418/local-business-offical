...
return new class extends Migration
{
    ...
    {
        Schema::create('production_flow_start_items', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('production_flow_start_id')->index()->nullable();
    ...
    {
        Schema::dropIfExists('production_flow_start_items');
    }
};
