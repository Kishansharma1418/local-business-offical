            ...
            <div class="m-lg-auto my-auto w-930 py-4">
                <div class="card bg-white border rounded-10 border-white py-100 px-130">
                    <div class="p-md-5 p-4 p-lg-0">
                        ...
                        <form method="post" action="{{ route('sign.in') }}" enctype="multipart/form-data"
                            id="signUp" class="validationForm" autocomplete="off">
                            @csrf
                            <div class="mb-20">
                                <label class="label fs-16 mb-2">Email Address / Phone</label>
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="floatingInput1" name="email_or_phone"
                                        placeholder="Enter email address/ phone *">
                                    <label for="floatingInput1">Enter email address/ phone *</label>
                                </div>
                            </div>
                            ...
                            <div class="position-relative text-center z-1 mb-12">
                                <span class="fs-16 bg-white px-4 text-secondary card d-inline-block border-0">or sign in
                                    with</span>
