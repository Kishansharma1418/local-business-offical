...
@section('content')
    ...
    <div class="main-content-container overflow-hidden">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4 mt-1">
            <h3 class="mb-0 fw-semibold">Add Invoice Order</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center mb-0 lh-1">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('invoice-orders.index') }}">Invoice Orders</a></li>
                    <li class="breadcrumb-item active">Add Invoice Order</li>
                </ol>
            </nav>
        </div>
        ...
        <form action="{{ route('store-invoice-directly') }}" method="POST" class="needs-validation" novalidate>
            @csrf

            <div class="card bg-white p-20 rounded-10 border border-white mb-4">
                <h4 class="fw-semibold mb-3"> Order Information</h4>
                <div class="row">
            ...
            <!-- <div class="card bg-white p-20 rounded-10 border border-white mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 mb-3">
                            <label class="label fs-16 mb-2" id="discountLabel">Overall Discount %</label>
                            <div class="d-flex gap-2">
                                <select id="discountType" class="form-control" style="width: 40%;">
                                    <option value="percent" selected>Percent (%)</option>
                                    <option value="amount">Amount (₹)</option>
                                </select>
                                <input type="number" id="overallDiscountInput" class="form-control" style="width: 60%;"
                ...
                <div class="mt-3 mb-4">
                    <button type="submit" id="submitBtn" class="btn btn-primary text-white px-4">Save Invoice Order</button>
                    <button type="submit" id="draftBtn" class="btn btn-secondary text-white px-4">Save As Draft</button>
                    <!-- <a href="{{ route('sale-orders.index') }}" class="btn btn-danger text-white px-4">Cancel</a> -->
                </div>
            </form>
...
@push('scripts')
    ...
    <script>
        ...
        //     if(!productId){ alert("Select Product First"); return; }
    ...
    //                 </tr>`;
        ...
        $(document).on('change', '.productSelect', function() {
            ...
            if (productId) {
                openBatchModal(productId, row);
            }
        });

        function openBatchModal(productId, row) {
            $.get(`/finished-goods/batches/${productId}`, function(res) {
                if (!res || res.length === 0) {
                    Swal.fire({
                        icon: 'error',
                    ...
                    row.find('.productSelect').val('').trigger('change');
        ...
        $('#addRow').click(function() {
            let newRow =
                ...
                <td><input type="number" name="items[${rowIndex}][quantity_ordered]" class="form-control qty" required value="1"></td>
