        <div class="modal-dialog modal-dialog-centered rounded-10" style="max-width: 550px;">
            <form class="modal-content bg-white" method="POST" enctype="multipart/form-data" id="edit_uom_form">
                @csrf
                @method('PUT')
                <input type="hidden" id="class_route" value="{{ route('uom.update', $uom->id) }}">

                <div class="modal-header border-border-color-40 p-20">
                    <h1 class="modal-title fs-18 fw-medium mb-0" id="exampleModalLabel">Edit UOM</h1>
                    ...
                    <div class="row">
                            ...
                            <div class="mb-20">
                                ...
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="floatingInput" name="name"
                                        placeholder="UOM Name" data-rule-required="true" value="{{ old('name', $uom->name) }}">
                            ...
                            <div class="mb-20">
                                ...
                                <div class="form-floating">
                                    <textarea name="description" class="form-control" id="description" cols="3" rows="16"
                                        placeholder="Example: Multiple strips/tablets in one box">{{ old('description', $uom->description) }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12 mb-20">
                            ...
                            <select class="form-select form-control" name="status">
                                <option value="1" {{ old('status', $uom->status) == '1' ? 'selected' : '' }}>Active
                                </option>
