    ...
    public function up(): void
    {
        Schema::create('invoice_orders', function (Blueprint $table) {
            ...
            $table->decimal('outstanding_amount', 18, 2)->default(0);
             $table->decimal('overall_bill_discount_amount', 18, 2)->nullable();
            $table->decimal('overall_bill_discount_percent', 5, 2)->nullable();
            $table->string('overall_bill_discount_type')->nullable();
