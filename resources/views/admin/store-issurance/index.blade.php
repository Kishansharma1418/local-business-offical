...
@section('content')
    <div class="main-content-container overflow-hidden">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4 mt-1">
            <h3 class="mb-0">Store issurance Batch</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center mb-0 lh-1">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <span class="text-secondary">Store Issurance Batch</span>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="card bg-white rounded-10 border border-white mb-4">
            ...
            <div class="default-table-area mx-minus-1">
                <div class="table-responsive overflow-none">
                    <table class="table" id="storeIssuranceTable">
                        <thead>
                            <tr>
                                <th>Batch Number</th>
                                <th>Finished Good</th>
        ...
        <div class="modal fade" id="assignteam" tabindex="-1" aria-labelledby="assignTeamModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered rounded-10" style="max-width: 550px;">
                <form id="assignTeamForm" class="modal-content bg-white" action="{{ route('assignTeam') }}" method="POST">
                    ...
                    <input type="hidden" id="stage" name="stage" value="STORE_ISSURANCE">
    ...
    @push('scripts')
        <script>
            $(function() {
                ...
                var table = $('#storeIssuranceTable').DataTable({
                    processing: true,
                    serverSide: true,

                    ajax: {
                        url: "{{ route('store-issurance.index') }}",
                        type: "GET",
                        data: function(d) {
        ...
        <script>
            $(document).on('click', '.assign-team-btn', function() {
                ...
                $.get(`/store-issurance-batch/${productionId}/roles`, function(roles) {
                    roles.forEach(role => {
