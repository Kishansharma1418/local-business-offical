...
@section('content')
    <div class="main-content-container overflow-hidden">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4 mt-1">
            <h3 class="mb-0">Add Advance Salary </h3>
        ...
        <form action="{{ route('loan-advances.store') }}" method="POST" class="needs-validation" novalidate>
            @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-20">
                        ...
                        <input type="number" name="loan_amount" id="loan_amount" min="0"
                            value="{{ old('loan_amount') }}" class="form-control" required min='0'>
                    </div>

                    <div class="col-lg-6 mb-20">
                        <label class="label fs-16 mb-2">Month <span class="text-danger">*</span></label>
                        <select name="month" id="month" class="form-select form-control" required>
                    ...
                    <div class="col-lg-6 mb-20">
                        ...
                        <input type="month" name="start_month" value="{{ old('start_month') }}" class="form-control"
                            required min="{{ date('Y-m') }}">
                    </div>
                    ...
                    <div class="col-lg-6 mb-20">
                        ...
                        <input type="number" name="deduction_amount" id="deduction_amount" min="0"
                            value="{{ old('deduction_amount') }}" class="form-control" readonly>
                    </div>
                    ...
                    <div class="col-lg-12 mt-3 d-flex gap-2">
                        <button type="submit" class="btn btn-primary fw-normal text-white">+ Add Advance Salary </button>
    ...
    @push('scripts')
        <script>
            ...
            document.getElementById('loan_amount').addEventListener('input', calculateDeduction);
            document.getElementById('month').addEventListener('change', calculateDeduction);
        </script>
    @endpush
@endsection
