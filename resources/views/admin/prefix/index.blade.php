            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center mb-0 lh-1">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <span class="text-secondary">Prefix List</span>
                    </li>
                </ol>
            </nav>
        </div>
                    ...
                    <table class="table" id="gstRateTable">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="fw-medium">Module</th>
                                <th scope="col" class="fw-medium">Prefix</th>
                                <th scope="col" class="fw-medium">Start From</th>
