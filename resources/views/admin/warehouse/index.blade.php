            ...
            <div class="d-flex align-items-center flex-wrap gap-3 p-20">
                ...
                {{-- @endcan --}}
                 <div class="d-flex align-items-center gap-2">
                    <select name="warehouse_name" id="nameFilter" class="form-control form-select-sm"
                        style="width: 180px; height: 50px;">
                        <option value="">All Warehouses </option>
                        @foreach ($warehouse as $t)
                            <option value="{{ $t->warehouse_name }}">{{ $t->warehouse_name }}</option>
                        @endforeach
                    </select>
                </div>
            </div>
...
$(function() {
    ...
    data: function (d) {
        d.warehouse_name  = $('#nameFilter').val();
    }
},
        ...
        columns: [
            ...
            { data: 'warehouse_purpose', name: 'warehouse_purpose' },
