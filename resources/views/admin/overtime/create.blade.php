...
@section('content')
    <div class="main-content-container overflow-hidden">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4 mt-1">
            <h3 class="mb-0">Add Employee Overtime</h3>
        ...
        <form method="POST" action="{{ route('overtime.store') }}" class="needs-validation" novalidate>
            @csrf
            <div class="row">
                <div class="col-lg-12">
                    <div class="card bg-white p-20 rounded-10 border border-white mb-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mb-20">
                                ...
                                <input type="number" name="rate_per_hour" id="rate_per_hour" class="form-control">
                            </div>
                            <div class="col-lg-6 mb-20">
