...
@section('content')
    <div class="main-content-container overflow-hidden">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4 mt-1">
            <h3 class="mb-0">GST Rate List</h3>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center mb-0 lh-1">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <span class="text-secondary">GST Rate List</span>
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="card bg-white rounded-10 border border-white mb-4">
            ...
            <div class="default-table-area mx-minus-1 ">
                <div class="table-responsive overflow-none">
                    <table class="table" id="gstRateTable">
                        <thead>
                            <tr>
                             
                                <th scope="col" class="fw-medium">GST Rate</th>
                                <th scope="col" class="fw-medium">CGST Rate</th>
                                <th scope="col" class="fw-medium">SGST Rate</th>
                                <th scope="col" class="fw-medium">IGST Rate</th>
...
@push('scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            if (!$.fn.DataTable.isDataTable('#gstRateTable')) {
                var dataTable = $('#gstRateTable').DataTable({
                    processing: true,
                    serverSide: true,
                    autoWidth: true,
                    scrollX: false,
             ...
             $(document).on('click', '.deleteBranchBtn', function() {
                if (confirm('Are you sure want to delete this gst rates?')) {
                    var id = $(this).data('id');
                    $.ajax({
                        url: "{{ url('gst-rates') }}/" + id,
                        type: 'DELETE',
                        data: {
                            _token: "{{ csrf_token() }}"
                        },
