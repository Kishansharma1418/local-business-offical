...
@section('content')
    <div class="main-content-container overflow-hidden">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4 mt-1">
            <h3 class="mb-0">Add Salary Component</h3>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb align-items-center mb-0 lh-1">
                    ...
                    <li class="breadcrumb-item">
                        <a href="{{ route('salary-component.index') }}" class="text-decoration-none">Salary Component List</a>
                    </li>
                    <li class="breadcrumb-item active">Add Salary Component</li>
                </ol>
            </nav>
        </div>
        ...
        <form method="POST" action="{{ route('salary-component.store') }}" class="needs-validation" novalidate>
            @csrf
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="component_name" id="component_name" class="form-control" 
                                       placeholder="Enter component name" required value="{{ old('component_name') }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="based_component_id" id="based_component_id" class="form-control">
                                    ...
                                    @foreach($components ?? [] as $component)
                                        <option value="{{ $component->id }}" {{ old('based_component_id') == $component->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" step="0.01" name="percentage_value" id="percentage_value" class="form-control" value="{{ old('percentage_value') }}">
                            </div>
                            ...
                            <div class="col-lg-12 mt-3">
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="{{ route('salary-component.index') }}" class="btn btn-danger fw-normal text-white">
                                        Cancel
                                    </a>
                                </div>
                            </div>
...
$(document).ready(function () {
    ...
    function handleCalculationType() {
        ...
        if (type === "Fixed") {
            $("#percentage_value").val("").closest('.col-md-6').hide();
            $("#based_component_id").val("").closest('.col-md-6').hide();
        } else {
            $("#percentage_value").closest('.col-md-6').show();
            $("#based_component_id").closest('.col-md-6').show();
        }
    }

    handleCalculationType();

    $("#calculation_type").on("change", handleCalculationType);
